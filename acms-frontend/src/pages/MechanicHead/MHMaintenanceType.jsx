// src/pages/MechanicHead/MHMaintenanceType.jsx
...
const MechanicHeadMaintenanceType = () => {
    ...
    <div className="animate-fadeIn">
      ...
      <div className="flex justify-between items-start mb-6">
        <div>
          ...
          <p className="text-gray-500 text-sm">Define and manage equipment maintenance and repair types</p>
        </div>
        <button 
          onClick={() => {
            setEditingType(null);
...
export default MechanicHeadMaintenanceType;